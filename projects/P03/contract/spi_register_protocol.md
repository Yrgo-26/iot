...
> **Kopia.** Det här är en ordagrann kopia av `project/spi_register_protocol.md` i hårdvarukursens repo,
> [Yrgo-26/programmable-logic](https://github.com/Yrgo-26/programmable-logic), inlagd här så
> att ni har kontraktet i ert eget repo. **Originalet är sanningskällan** och vinner vid konflikt;
> ändras det måste båda klasserna veta om det innan ändringen mergas. Hittar ni en avvikelse
> mellan den här kopian och originalet: rapportera den, ändra inte kopian.
>
> Sammanfattningarna i kursmaterialet finns i
> [L04 bilaga B](../../../lectures/L04/appendix/b_register_map_and_architecture.md) och
> [L08 bilaga A](../../../lectures/L08/appendix/a_spi.md). De är skrivna för att räcka till
> **P03**; det här dokumentet är den fullständiga versionen.
>
> Länkar som pekade in i hårdvaruklassens repo är avlänkade i kopian, eftersom de målen inte
> finns här.
>
> **Läs rollerna baklänges.** Texten är skriven från hårdvaruklassens håll: "den här kursen"
> betyder deras kurs, och "parallellklassen" betyder er.

---

This is the contract at the centre of the project, and it is written for **two classes at once**:
this course builds the FPGA side as an SPI slave, in L18 and
L19, and a parallel class builds the MCU side as a master. Both
...
the project specification, section 6.7 for the other simplifications against real
CAN.
