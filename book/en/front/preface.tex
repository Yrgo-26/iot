...
One more book belongs to the course, and it is not needed to pass it: \textit{CAN --- the bus,
the frame and the controller}, the course's own book about CAN as a protocol. It covers the bus,
the frame, bit stuffing, CRC-15, arbitration, bit timing and error handling, with exercises and
